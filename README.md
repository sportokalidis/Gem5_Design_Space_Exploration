...
Η εργασία δεν ήταν ιδιαίτερα απαιτητική όσον άφορα την κατανόηση και την υλοποίηση των διάφορων ερωτημάτων. Ωστόσο, ήταν χρονοβόρα κυρίως στο δεύτερο κομμάτι της άσκησης. Επιπλέον , η εργασία αυτή αποτελεί μια Καλή ευκαιρία να ασχοληθούμε με το simulator gem5 και να μάθουμε επιπλέον πράγματα σχετικά με την ιεραρχία μνήμης αναζητώντας πληροφορίες στην βιβλιογραφία.
Επιπρόσθετα, η εργασία αυτή απαιτεί κριτική σκέψη, ώστε να εφαρμόσουμε την θεωρία στην πράξη, πράγμα που είναι ιδιαίτερα σημαντικό. 
